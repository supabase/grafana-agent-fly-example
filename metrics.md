...
pgbouncer_version_info{version="PgBouncer 1.17.0"}
...
postgres_exporter_build_info{service_type="postgresql",branch="",goversion="go1.15.8",revision="",version="0.0.1"}
...
process_start_time_seconds{service_type="postgresql"}
...
process_cpu_seconds_total{service_type="postgresql"}
...
process_resident_memory_bytes{service_type="postgresql"}
# HELP process_virtual_memory_max_bytes Maximum amount of virtual memory available in bytes.
# TYPE process_virtual_memory_max_bytes gauge
process_virtual_memory_max_bytes{service_type="postgresql"}
...
process_open_fds{service_type="postgresql"}
...
process_max_fds{service_type="postgresql"}
...
process_virtual_memory_bytes{service_type="postgresql"}
